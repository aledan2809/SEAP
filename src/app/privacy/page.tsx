    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <header className="sticky top-0 z-50 border-b bg-white/95 dark:bg-gray-950/95 backdrop-blur">
        <div className="max-w-3xl mx-auto flex h-14 items-center gap-4 px-4">
          <Link href="/" className="text-sm text-gray-700 underline hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100">
            &larr; Înapoi
          </Link>
      ...
      <main className="max-w-3xl mx-auto py-10 px-4 space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            contactați-ne la{' '}
            <a href="mailto:support@4pro.io" className="text-blue-700 underline hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">support@4pro.io</a>.
          </p>
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ANSPDCP:{' '}
            <a href="https://www.dataprotection.ro" target="_blank" rel="noopener noreferrer" className="text-blue-700 underline hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
